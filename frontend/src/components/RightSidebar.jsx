...
const [currentTime] = useState(() => Date.now());
  ...
  return (
    <div className="w-80 shrink-0 hidden lg:flex flex-col gap-4 sticky top-5 max-h-[calc(100vh-88px)] overflow-y-auto no-scrollbar pb-4">
            ...
            <>
              ...
              <div className="px-4 pb-4 flex flex-col items-center">
                ...
                <button
                  ...
                  className="btn-press w-full bg-transparent text-gray-900 dark:text-gray-300 border border-black dark:border-[#343536] font-bold py-2.5 rounded-full hover:bg-gray-50 dark:hover:bg-[#272729] mt-2.5 transition-all text-sm"
                >
                  👥 Create Community
                </button>
              </div>
